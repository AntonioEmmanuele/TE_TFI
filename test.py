...
kmeans_features = KMeans(n_clusters=2, random_state=42)
...
clusters_raw = kmeans_raw.fit_predict(reshaped_series)

# Calculate silhouette score for raw approach
silhouette_raw = silhouette_score(reshaped_series, clusters_raw)
